        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.1 }}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 md:gap-4 mb-4 sm:mb-6">
            <Button
              ...
              variant="outline" className="bg-background text-slate-950 px-4 py-2 text-xs font-medium tracking-widest rounded-md inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 shadow-sm hover:bg-accent hover:text-accent-foreground h-10 sm:h-12 md:h-14 sm:text-sm md:text-base border-2 border-zinc-800">
            ...
            <Button
              ...
              variant="outline" className="bg-background text-slate-950 px-4 py-2 text-xs font-medium tracking-widest rounded-md inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 shadow-sm hover:bg-accent hover:text-accent-foreground h-10 sm:h-12 md:h-14 sm:text-sm md:text-base border-2 border-zinc-800 col-span-2 sm:col-span-1">
