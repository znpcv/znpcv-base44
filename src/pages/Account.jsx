        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.1 }}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
            <Button
              ...
              variant="outline" 
              className={`h-9 sm:h-10 text-xs tracking-widest border-2 ${theme.border}`}>
            ...
            <Button
              ...
              className="h-9 sm:h-10 text-xs tracking-widest border-2 bg-rose-600 hover:bg-rose-700 text-white border-rose-600">
