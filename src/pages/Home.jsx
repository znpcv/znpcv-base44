      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16">
        ...
        >
          ...
          <button
            ...
            className="group relative p-8 rounded-3xl hover:shadow-2xl transition-all text-left overflow-hidden bg-zinc-800 text-white border-2 border-zinc-700 hover:border-zinc-600"
          >
            {/* Decorative elements */}
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl tracking-wider mb-3 font-bold text-white">{t('newAnalysis')}</h2>
              <p className="text-sm leading-relaxed mb-6 font-sans max-w-xs text-zinc-300">
                {t('newAnalysisDesc')}
              </p>

              <div className="flex items-center gap-3 font-bold tracking-widest text-white">
                <span className="text-lg">{t('startNow')}</span>
                <div className="w-10 h-10 rounded-xl flex items-center justify-center group-hover:translate-x-2 transition-transform bg-white text-zinc-900">
