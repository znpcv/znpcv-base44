            ...
            className={`border-2 ${theme.border} rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-6 ${theme.bgCard}`}>
              ...
              <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button onClick={() => setEditing(false)} className={`h-10 sm:h-11 px-4 border-2 font-bold rounded-xl transition-all ${darkMode ? 'bg-zinc-900 border-zinc-800 text-zinc-400 hover:text-white hover:border-zinc-700' : 'bg-zinc-100 border-zinc-300 text-zinc-600 hover:text-black hover:border-zinc-400'}`}>
                      <X className="w-4 h-4" />
                    </Button>
                  </div>
                </div> :
