        ...
        <div className="relative px-5 py-6">
          ...
          <div className="text-center mb-5">
            ...
            <div className="flex items-center justify-center gap-4">
              <div className={cn(
                "px-5 py-1.5 rounded-lg text-xs font-black",
                isLong 
              ...
              <div className="text-center">
                ...
                <div className={cn(
                  "text-[9px] font-bold tracking-[0.25em] mt-0.5",
          ...
          <div className="space-y-2 mb-5">
            ...
            {trade.take_profit && (
              <div className={cn(
                ...
                <span className="text-[10px] font-bold tracking-[0.2em] text-emerald-500">
                  TP
                </span>
          ...
          <div className="grid grid-cols-3 gap-2">
            {rr && (
              <div className={cn(
                "px-2 py-2.5 rounded-lg text-center border",
                darkMode ? "bg-zinc-950/50 border-zinc-800" : "bg-zinc-50 border-zinc-200"
              )}>
          ...
          {/* Footer */}
          <div className={cn(
            "flex items-center justify-center pt-4 mt-4 border-t",
