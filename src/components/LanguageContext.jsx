...
const translations = {
  zh: {
    ...
    entryTimeframeDesc: '30分钟至1小时（30分钟-1小时）',
  ...
  es: {
    ...
    entryTimeframeDesc: '30 Minutos a 1 Hora (30min - 1H)',
  ...
  fr: {
    ...
    entryTimeframeDesc: '30 Minutes à 1 Heure (30min - 1H)',
  ...
  hi: {
    ...
    entryTimeframeDesc: '30 मिनट से 1 घंटा (30min - 1H)',
  ...
  ja: {
    ...
    entryTimeframeDesc: '30分から1時間（30分-1H）',
  ...
  ar: {
    ...
    entryTimeframeDesc: '30 دقيقة إلى ساعة واحدة (30min - 1H)',
