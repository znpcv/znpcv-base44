...
const translations = {
  zh: {
    ...
    goldenRuleText: '我们不在阻力位买入，不在支撑位卖出。买入 = AOI支撑 / 卖出 = AOI阻力',
    ...
    entryTimeframeDesc: '30分钟或1小时 - 取决于最清晰的结构（波段/日内交易）',
  ...
  es: {
    ...
    goldenRuleText: 'NO compramos en resistencia y NO vendemos en soporte. Long = AOI Soporte / Short = AOI Resistencia',
    ...
    entryTimeframeDesc: '30min o 1H - según estructura más limpia (Swing/Day Trading)',
  ...
  fr: {
    ...
    goldenRuleText: 'Nous n\'achetons PAS à la résistance et ne vendons PAS au support. Long = AOI Support / Short = AOI Résistance',
    ...
    entryTimeframeDesc: '30min ou 1H - selon la structure la plus propre (Swing/Day Trading)',
  ...
  hi: {
    ...
    goldenRules: 'ZNPCV सुनहरे नियम',
    goldenRuleText: 'हम रेजिस्टेंस पर नहीं खरीदते और सपोर्ट पर नहीं बेचते। लॉन्ग = AOI सपोर्ट / शॉर्ट = AOI रेजिस्टेंस',
    ...
    entryTimeframeDesc: '30min या 1H - सबसे साफ संरचना पर निर्भर (स्विंग/डे ट्रेडिंग)',
  ...
  ja: {
    ...
    goldenRuleText: 'レジスタンスで買わない、サポートで売らない。ロング = AOIサポート / ショート = AOIレジスタンス',
    ...
    entryTimeframeDesc: '30分または1時間 - 最もクリーンな構造による（スイング/デイトレード）',
  ...
  pt: {
    ...
    goldenRules: 'REGRAS DE OURO ZNPCV',
    goldenRuleText: 'NÃO compramos na resistência e NÃO vendemos no suporte. Long = AOI Suporte / Short = AOI Resistência',
    ...
    entryTimeframeDesc: '30min ou 1H - dependendo da estrutura mais limpa (Swing/Day Trading)',
  ...
  ar: {
    ...
    goldenRuleText: 'لا نشتري عند المقاومة ولا نبيع عند الدعم. شراء = AOI دعم / بيع = AOI مقاومة',
    ...
    entryTimeframeDesc: '30 دقيقة أو ساعة واحدة - حسب أنظف هيكل (تداول متأرجح/يومي)',
  ...
  de: {
    ...
    goldenRuleText: 'Wir kaufen NICHT am Widerstand und verkaufen NICHT am Support. Long = AOI Support / Short = AOI Resistance',
    ...
    entryTimeframeDesc: '30min oder 1H - je nach sauberster Struktur (Swing/Day Trading)',
  ...
  en: {
    ...
    goldenRuleText: 'We do NOT buy at resistance and do NOT sell at support. Long = AOI Support / Short = AOI Resistance',
    ...
    entryConfirm: 'Entry Confirmations (max 25%)',
    entryTimeframe: 'ENTRY TIMEFRAME',
    entryTimeframeDesc: '30min or 1H - depending on cleanest structure (Swing/Day Trading)',
    entryScoreLabel: 'ENTRY SCORE',
    mssShift: 'MSS - MARKET STRUCTURE SHIFT',
  ...
  fa: {
    ...
    goldenRuleText: 'ما در مقاومت خرید نمی‌کنیم و در حمایت نمی‌فروشیم. لانگ = AOI حمایت / شورت = AOI مقاومت',
    ...
    entryTimeframeDesc: '۳۰ دقیقه یا ۱ ساعت - بسته به تمیزترین ساختار (سوئینگ/دی تریدینگ)',
