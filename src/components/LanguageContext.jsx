...
const translations = {
  ...
  de: {
    ...
    goldenRules: 'ZNPCV GOLDENE REGEL',
    goldenRuleText: 'Niemals am Widerstand kaufen. Niemals am Support verkaufen. Ein LONG Trade erfolgt ausschließlich im oder über dem AOI (Support-Zone). Ein SHORT Trade erfolgt ausschließlich im oder unter dem AOI (Resistance-Zone).',
    ...
    entryTimeframeDesc: 'Wähle zwischen 30min oder 1H Timeframe - abhängig davon, welcher die sauberste Struktur und den präzisesten Entry bietet. Wir sind Swing/Day Trader und handeln höhere Timeframes, kein Scalping.',
  ...
  en: {
    ...
    goldenRules: 'ZNPCV GOLDEN RULE',
    goldenRuleText: 'Never buy at resistance. Never sell at support. A LONG trade is only taken in or above the AOI (Support zone). A SHORT trade is only taken in or below the AOI (Resistance zone).',
    ...
    entryConfirm: 'Entry Confirmations (max 25%)',
    entryTimeframe: 'ENTRY TIMEFRAME',
    entryTimeframeDesc: 'Choose between 30min or 1H timeframe - depending on which provides the cleanest structure and most precise entry. We are Swing/Day Traders focusing on higher timeframes, not scalpers.',
    entryScoreLabel: 'ENTRY SCORE',
    mssShift: 'MSS - MARKET STRUCTURE SHIFT',
